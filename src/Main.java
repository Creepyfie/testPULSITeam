...
public class Main {
    public static void main(String[] args) {
        List<Integer> myList = List.of(10,2,3,45,1,23,4,23);

        Result<Integer> myResult = findMinMax(myList);
    ...
    public static <T extends Comparable<T>> Result<T> findMinMax(Collection<T> elements, Comparator<T> comparator) {
